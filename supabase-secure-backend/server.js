...
async function getCohortStatus(cluster_id, user_id) {
    ...
    try {
        ...
        // This is the most reliable way to check if the user is a member (Issue #2 fix).
        ...
        // We need to fetch the current active cohort ID and VCF status from the cluster_metadata table.
