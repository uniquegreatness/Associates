...
async function getCohortStatus(cluster_id, user_id) {
    ...
    try {
        ...
        // This line now works because the 'vcf_uploaded' column exists.
        ...
        if (cohortStatus.is_full) {
            ...
            if (fetchError || !allContacts || allContacts.length === 0) {
                ...
                if (uploadError) {
                    ...
                    // 2d. FIX: Update VCF Upload Status in cluster_metadata (Now functional with the new database column)
            ...
            // NOTE: Assuming the database function is set up to handle this cleanup correctly.
