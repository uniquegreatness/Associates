...
function calculateClusterStats(members, userCountry) {
    ...
    if (userCountryCount > 0 || abroadCount === 0) { // Only display user country if found or if no members exist
    ...
    if (abroadCount > 0) {
        ...
        // If all members are from the user's country, Abroad should be 0
        if (!geographic_mix['Abroad']) {
